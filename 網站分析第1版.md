...
<html>
<head>
    <title>Cafe Unlimited - Home</title> //表頭顯示
...
<body id="body" style="background-image:url(images/background.png)">  //背景圖

<!-- Banner -->
<p>
    <img src="images/banner.png" alt="Cafe Unlimited - Banner">    //圖片呈現 1
</p>

<!-- Navigation links -->
<p style="background:slategray;font-weight: bolder;">
    <a href="index.html">Home</a>             //圖片呈現 2
    <a href="breakfast.html">Breakfast</a>    //圖片呈現 3
</p>
...
<!--Javascript -->
<button type="button" onclick="bigger()">Bigger</button>   //放大按鈕
<button type="button" onclick="smaller()">Smaller</button> //縮小按鈕

<h1>Welcome</h1>   //內文標頭 
<p>                //內文
    Welcome to Cafe Unlimited. We serve award-winning breakfasts and lunches,
...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2948.8366673124624!2d-71.05369318489703!3d42.346005543982265!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89e37a7de82a1251%3A0xb79b53cf96e26c94!2s20+Channel+Center+St%2C+Boston%2C+MA+02210!5e0!3m2!1sen!2sus!4v1543445329233" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>  // google map 內嵌地圖
<p>    We are open:</p>
